...
{
    CGRect rect = CGRectMake(0,0,200,378);
...
+ (NSString *)classifyPeanut:(UIImage *)image {
    ...
    cv::Mat imageMat;
    UIImageToMat(image, imageMat);
    cv::resize(imageMat, imageMat, cv::Size(200,378));
    ...
    std::ifstream iffy;
    /*
     code to pull in red blue and green not working, iOS sandboxes files from C++ code...
    ...
    iffy.close();*/
        ...
        //kinda janky, instead I hardcoded the groundtruth vectors
